...
description: Review pull requests, diffs, and completed code changes for correctness, regressions, security, performance, maintainability, and hidden assumptions. Use before merging meaningful changes, when the user requests review or audit, or when an independent quality gate is needed.
---
