...
description: Prepare and verify safe releases, CI/CD pipelines, deployment automation, environment configuration, staged rollouts, migrations, health checks, rollback, and launch readiness. Use when meaningful software changes are being shipped or production delivery behavior changes.
---
...
- Use repo docs such as `AGENTS.md`, `CLAUDE.md`, `ORCHESTRATOR.md`, `TESTING.md`, or deployment notes when they exist
