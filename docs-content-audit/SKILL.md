...
description: Audit repository documentation and agent context for load order, authority, portability, drift, duplication, contradictions, context cost, and durable-versus-transient separation. Use when reviewing README, AGENTS.md, context indexes, repository instructions, or agent context design.
---
