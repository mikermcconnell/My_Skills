...
description: Plan and deliver non-trivial software features through requirements, authoritative-source checks, incremental implementation, testing, migration planning, verification, and durable closeout. Use for meaningful features, vague requests that need a specification, multi-step implementation plans, or replacement of existing behavior.
---
