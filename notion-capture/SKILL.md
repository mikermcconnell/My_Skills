---
name: notion-capture
description: Capture, review, and safely clean up Mike-specific Notion notes, tasks, projects, and workspace metadata. Use when turning rough material into Notion records, running workspace or overdue reviews, correcting metadata, or planning bulk changes beyond the generic Notion plugin workflow.
---
