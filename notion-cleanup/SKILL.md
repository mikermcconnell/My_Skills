---
name: notion-cleanup
description: Bulk update, fix, or remove problematic Notion entries. Use when the user wants help cleaning up tasks, projects, metadata, or other Notion workspace issues.
---
