---
name: notion-review
description: Analyze Notion workspace health and surface items needing attention. Use for weekly reviews, overdue task scans, metadata audits, and cleanup recommendations.
---
