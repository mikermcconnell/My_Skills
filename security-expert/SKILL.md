...
description: Review and harden software across trust boundaries, authentication, authorization, secrets, user input, files, data storage, Firebase rules, APIs, and external integrations. Use for security reviews, sensitive features, threat analysis, unsafe data paths, or release decisions with realistic security risk.
---
...
- Use repo docs such as `AGENTS.md`, `CLAUDE.md`, `ORCHESTRATOR.md`, deployment notes, auth docs, or environment docs when they exist
