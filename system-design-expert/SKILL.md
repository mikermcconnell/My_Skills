...
description: Design practical software architecture, APIs, shared contracts, module boundaries, data flow, and stable interfaces. Use when a feature changes system structure, introduces an API or event contract, crosses frontend/backend boundaries, or requires compatibility and migration decisions.
---
...
- Use repo docs such as `AGENTS.md`, `CLAUDE.md`, `ORCHESTRATOR.md`, architecture notes, or feature docs when they exist
