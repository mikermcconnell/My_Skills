...
description: Create and improve developer documentation, READMEs, setup guides, API docs, migration notes, tutorials, architecture decision records, and durable technical handoffs. Use when software decisions or operating knowledge must be clear to future people or agents.
---
