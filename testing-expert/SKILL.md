---
name: testing-expert
description: Design and run practical unit, integration, regression, UI, and end-to-end testing, including test-first development and mocking strategy. Use for meaningful features, bug fixes, changed behavior, test planning, flaky tests, edge cases, or proof that an output works.
---
...
- Use repo docs such as `AGENTS.md`, `CLAUDE.md`, `ORCHESTRATOR.md`, or `TESTING.md` when they exist
