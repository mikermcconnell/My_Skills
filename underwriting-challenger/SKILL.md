...
1. receive the evidence ledger, source pack, capital structure, model assumptions, and current price;
...
- Separate disagreement about facts, mechanisms, probabilities, valuation, timing, and portfolio fit.
...
- is the metric the correct denominator?
...
Check whether expected annualized return, downside, duration, liquidity, confidence, and correlation justify the conclusion relative to the stated hurdle and closest alternative.
...
- **SURVIVES WITH REVISIONS** — case remains viable but price, probability, valuation, timing, or posture must change.
- **NOT DECISION-READY** — a load-bearing fact, model input, or challenge remains unresolved.
- **FAILS** — core thesis, valuation, downside, or hurdle does not survive.
...
List only changes that affect value, probability, timing, posture, or monitoring.
...
Do not provide exact portfolio sizing or execute a trade. Do not rewrite the original underwriting silently. The primary underwriter owns the reconciled conclusion and model update.
